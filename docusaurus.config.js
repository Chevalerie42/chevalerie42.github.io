...
const config = {
  ...
  tagline: 'Système, Réseau, Pentest, voire même un peu de Dev. Tout y passe !',
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/chevalerie42/chevalerie42.github.io/edit/main/',
            feedOptions: {
            type: 'rss',
            language: 'fr',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        logo: {
          alt: 'Chevalerie',
          src: 'img/Page_Accueil/Logo_Chevalerie_Footer.png',
          href: 'https://chevalerie42.github.io',
        },
        copyright: `Copyright © ${new Date().getFullYear()} & tout Droit d'Auteur réservé a "Chevalerie" ! ⚔️ <br><br> <a class="footer__link-item" href="/Mentions_Legale" target="_blank">Mention légales 🚔</a>`,
      },
      prism: {
      ...
      metadata: [{
        name: "name", content: "Les tutos de CheChe"
      },
      {
        name: "title", content: "Les tutos de Chevalerie !"
      },
      {
      ...
      {
        name: "copyright", content: "Copyright © ${new Date().getFullYear()} & tout Droit d'Auteur réservé a 'Chevalerie' ! ⚔️"
      },
      {
        property:"og:title", content:"Les tutos de Chevalerie !"
      },
      {
      ...
      {
        property:"og:image", content:"https://chevalerie42.github.io/img/Page_Accueil/Logo_Chevalerie.png"
      },
      {
        name:"twitter:card", content:"summary_large_image"
      },
      {
        name:"twitter:title", content:"Les tutos de Chevalerie !"
      },
      {
      ...
      {
        name:"twitter:image", content:"https://chevalerie42.github.io/img/Page_Accueil/Logo_Chevalerie.png"
      },
    ],
      algolia: {
        appId: 'YOUR_APP_ID',
